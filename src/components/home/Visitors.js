...
function Visitors() {
  ...
  return (
    ...
    <div className='flex justify-between'>
      <h6 className='2xl:text-[22px] md:text-[20px] font-medium text-gray-400'>New visitors</h6>
      <p className='text-gray-400'>Last Week</p>
    </div>
   <div className='flex justify-between items-end'>
    <div>
    <h2 className='2xl:text-[40px] md:text-[36px] text-[#5A697D] font-medium'>23%</h2>
