    ...
    <div className='bg-white rounded-xl p-6 box-shadow-1 col-span-2'>
        <table className='w-full'>
          ...
          <tr>
            ...
            <td>Apple</td>
            <td>$500</td>
            <td className='p-2 bg-green-200 rounded-md xl:text-[16px] xm:text-[14px]'>Complete</td>
           ...
           <tr>
            ...
            <td>Banana</td>
            <td>$400</td>
            <td className='p-2 bg-blue-200 rounded-md xl:text-[16px] xm:text-[14px]'>Procecing..</td>
           ...
           <tr>
            ...
            <td>Mango</td>
            <td>$345</td>
            <td className='p-2 bg-red-100 rounded-md xl:text-[16px] xm:text-[14px]'>Canceled</td>
            <td> <BiDotsVerticalRounded className=' cursor-pointer' /></td>
           </tr>
           <tr>
           ...
           <tr>
            ...
            <td>Apple</td>
            <td>$500</td>
            <td className='p-2 bg-yellow-100 rounded-md xl:text-[16px] xm:text-[14px]'>Panding...</td>
            <td> <BiDotsVerticalRounded className=' cursor-pointer' /></td>
           </tr>
          </tbody>
        </table>
