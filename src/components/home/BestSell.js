...
function BestSell() {
  ...
  return (
    <div className='bg-white rounded-xl p-6 box-shadow-1'>
        <div className='grid grid-flow-row xl:grid-cols-2 xm:grid-cols-1'>
        <div>
          ...
          <button className='2xl:py-2 2xl:px-4 lg:py-1 lg:px-2 rounded-md 2xl:text-[16px] xl:text-[14px] 2xl:rounded-lg bg-[#6A6CF6] text-gray-100 xl:mt-4 lg:mt-0'>View Sales</button>
        </div>
        <div className='flex items-end justify-center lg:invisible xl:visible'>
